...
export default function ContactInfoBar() {
  ...
  return (
    <div className="bg-[#06A0A6] text-white py-2 px-4 sm:px-6 lg:px-8 sticky top-0 z-50 border-b border-[#06A0A6]/20">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row justify-center sm:justify-between items-center text-sm">
          {/* Contact Information */}
          <div className="flex flex-wrap justify-center sm:justify-start items-center gap-4 sm:gap-6 mb-2 sm:mb-0">
            {/* Phone */}
            <button
            ...
            >
             ...
             >
               ...
               <span className="sm:hidden">{contactInfo.whatsapp}</span>
             </button>
          ...
          <div className="text-center sm:text-right">
            <span className="text-xs sm:text-sm opacity-90">24/7 Service Available</span>
          </div>
        </div>
      </div>
    </div>
