...
const schemaData = {
  ...
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    "@id": "https://aylestone-taxis.co.uk/#services",
    name: "Taxi Services",
    itemListElement: [
      { "@type": "Offer", position: 1, itemOffered: { "@type": "Service", name: "Airport Transfers Leicester", provider: { "@id": "https://aylestone-taxis.co.uk/#business" } } },
      { "@type": "Offer", position: 2, itemOffered: { "@type": "Service", name: "Local Taxi Leicester", provider: { "@id": "https://aylestone-taxis.co.uk/#business" } } },
      { "@type": "Offer", position: 3, itemOffered: { "@type": "Service", name: "Long Distance Taxi", provider: { "@id": "https://aylestone-taxis.co.uk/#business" } } },
      { "@type": "Offer", position: 4, itemOffered: { "@type": "Service", name: "Corporate Taxi Accounts", provider: { "@id": "https://aylestone-taxis.co.uk/#business" } } },
      { "@type": "Offer", position: 5, itemOffered: { "@type": "Service", name: "Minibus Hire Leicester", provider: { "@id": "https://aylestone-taxis.co.uk/#business" } } },
      { "@type": "Offer", position: 6, itemOffered: { "@type": "Service", name: "Wheelchair Accessible Taxi", provider: { "@id": "https://aylestone-taxis.co.uk/#business" } } },
      { "@type": "Offer", position: 7, itemOffered: { "@type": "Service", name: "Pre-Booked Journeys", provider: { "@id": "https://aylestone-taxis.co.uk/#business" } } },
      { "@type": "Offer", position: 8, itemOffered: { "@type": "Service", name: "School Runs", provider: { "@id": "https://aylestone-taxis.co.uk/#business" } } },
      { "@type": "Offer", position: 9, itemOffered: { "@type": "Service", name: "Group Travel / Larger Vehicles", provider: { "@id": "https://aylestone-taxis.co.uk/#business" } } },
      { "@type": "Offer", position: 10, itemOffered: { "@type": "Service", name: "Hospital & Medical Appointments", provider: { "@id": "https://aylestone-taxis.co.uk/#business" } } },
      { "@type": "Offer", position: 11, itemOffered: { "@type": "Service", name: "Wheelchair Accessible Vehicles", provider: { "@id": "https://aylestone-taxis.co.uk/#business" } } },
      { "@type": "Offer", position: 12, itemOffered: { "@type": "Service", name: "Event Transport", provider: { "@id": "https://aylestone-taxis.co.uk/#business" } } },
      { "@type": "Offer", position: 13, itemOffered: { "@type": "Service", name: "Shopping & Retail", provider: { "@id": "https://aylestone-taxis.co.uk/#business" } } },
      { "@type": "Offer", position: 14, itemOffered: { "@type": "Service", name: "Railway Station Transfers", provider: { "@id": "https://aylestone-taxis.co.uk/#business" } } },
      { "@type": "Offer", position: 15, itemOffered: { "@type": "Service", name: "Hotel Transfers", provider: { "@id": "https://aylestone-taxis.co.uk/#business" } } },
      { "@type": "Offer", position: 16, itemOffered: { "@type": "Service", name: "Restaurant & Dining", provider: { "@id": "https://aylestone-taxis.co.uk/#business" } } },
      { "@type": "Offer", position: 17, itemOffered: { "@type": "Service", name: "Courier & Parcel Services", provider: { "@id": "https://aylestone-taxis.co.uk/#business" } } },
    ],
  },
  sameAs: [
