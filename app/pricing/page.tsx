                 ...
                 <table className="w-full bg-white rounded-2xl shadow-xl border border-cyan-200 overflow-hidden">
                  <thead>
                    <tr className="bg-gradient-to-r from-cyan-600 to-cyan-700 text-white">
                      ...
                      <th className="px-5 py-3 text-left font-semibold text-base">1-4 seater (from)</th>
                      <th className="px-5 py-3 text-left font-semibold text-base">6/8 seater (from)</th>
                    </tr>
                  </thead>
                  <tbody>
