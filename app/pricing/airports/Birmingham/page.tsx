      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: "Leicester to Birmingham Airport Taxi",
            description:
              "Fixed-price taxi transfer from Leicester and Leicestershire to Birmingham Airport (BHX). 24/7 service, flight monitoring, meet & greet available. Licensed drivers.",
            provider: {
              "@type": "LocalBusiness",
            ...
            offers: {
              "@type": "Offer",
              description: "Fixed price taxi from Leicester to Birmingham Airport",
              priceCurrency: "GBP",
              priceSpecification: {
