      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: "Leicester to Luton Airport Taxi",
            description:
              "Fixed-price taxi transfer from Leicester and Leicestershire to Luton Airport (LTN). 24/7 service, flight monitoring, meet & greet available. Licensed drivers.",
            provider: {
            ...
            offers: {
              "@type": "Offer",
              description: "Fixed price taxi from Leicester to Luton Airport",
              priceCurrency: "GBP",
              priceSpecification: {
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                Reliable transfers to Luton Airport
              </h1>
              <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-12 leading-relaxed">
                Professional taxi service from Leicester and surrounding areas to Luton Airport. 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Fixed rates from Leicester and surrounding areas to Luton Airport. 
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className="border-b border-cyan-100 hover:bg-cyan-50 transition-colors duration-200">
                      ...
                      <td className="px-6 py-4 text-right text-cyan-700 font-semibold text-lg">from £120</td>
                    </tr>
                    <tr className="border-b border-cyan-100 hover:bg-cyan-50 transition-colors duration-200">
                      <td className="px-6 py-4 font-medium text-gray-900">
                        <div className="flex items-center space-x-3">
                      ...
                      <td className="px-6 py-4 text-right text-cyan-700 font-semibold text-lg">from £160</td>
                    </tr>
        ...
        <section className="py-20 bg-gray-50 bg-gradient-to-r from-[#06A0A6]/10 to-transparent">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Professional, reliable, and comfortable transfers to Luton Airport
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
                Everything you need to know about your journey to Luton Airport
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-gray-600 text-center">
                  Relax in comfort as we take you directly to Luton Airport terminal. We monitor traffic and adjust routes for optimal timing.
                </p>
              </div>
        ...
        <section className="py-20 bg-gradient-to-r from-[#06A0A6] to-[#0F0D3E] text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-white text-4xl md:text-5xl font-bold mb-6">
              Ready to book your Luton transfer?
            </h2>
