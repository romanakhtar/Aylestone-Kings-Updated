                ...
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className="border-b border-cyan-100 hover:bg-cyan-50 transition-colors duration-200">
                      ...
                      <td className="px-6 py-4 text-right text-cyan-700 font-semibold text-lg">from £40</td>
                    </tr>
                    <tr className="border-b border-cyan-100 hover:bg-cyan-50 transition-colors duration-200">
                      <td className="px-6 py-4 font-medium text-gray-900">
                        <div className="flex items-center space-x-3">
        ...
        <section className="py-20 bg-gray-50 bg-gradient-to-r from-[#06A0A6]/10 to-transparent">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Professional, reliable, and comfortable transfers to East Midlands Airport
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
                Everything you need to know about your journey to East Midlands Airport
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-gray-600 text-center">
                  Relax in comfort as we take you directly to East Midlands Airport terminal. We monitor traffic and adjust routes for optimal timing.
                </p>
              </div>
        ...
        <section className="py-20 bg-gradient-to-r from-[#06A0A6] to-[#0F0D3E] text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-white text-4xl md:text-5xl font-bold mb-6">
              Ready to book your East Midlands transfer?
            </h2>
